...
{
    class DaylightDurationCalculatorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/daylightduration";

        /// <summary>
        /// Make a GET request to the Daylight Duration Calculator API
        /// </summary>
        static async Task<JsonDocument> CallDaylightDurationCalculatorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;latitude&quot;] &#x3D; 40.7128, [&quot;longitude&quot;] &#x3D; -74.0060, [&quot;date&quot;] &#x3D; &quot;2024-06-21&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Daylight Duration Calculator API...\n");

            var result = await CallDaylightDurationCalculatorAPI();
