# Daylight Duration Calculator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:daylightduration-api:1.1.12'
}
```
...
```java
import com.apiverve.daylightduration.DaylightDurationCalculatorAPIClient;
import com.apiverve.daylightduration.APIResponse;
import com.apiverve.daylightduration.APIException;

// Initialize the client
DaylightDurationCalculatorAPIClient client = new DaylightDurationCalculatorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/daylightduration](https://docs.apiverve.com/ref/daylightduration)
...
- **Documentation:** [https://docs.apiverve.com/ref/daylightduration](https://docs.apiverve.com/ref/daylightduration)
- **Issues:** [GitHub Issues](https://github.com/apiverve/daylightduration-api/issues)
