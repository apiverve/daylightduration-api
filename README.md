...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/daylightduration](https://docs.apiverve.com/ref/daylightduration)

---

## Use Cases

Common use cases for the Daylight Duration Calculator API:
