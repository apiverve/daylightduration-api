...
class TestDaylightdurationAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = DaylightdurationAPIClient(self.api_key)

    @patch('apiverve_daylightdurationcalculator.apiClient.requests.get')
