...
namespace APIVerve.API.DaylightDurationCalculator
{
    ...
    /// <summary>
    /// Client for the DaylightDurationCalculator API
    /// </summary>
    public class DaylightDurationCalculatorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/daylightduration";
        ...
        {
            { "latitude", new ValidationRule { Type = "number", Required = true, Min = -90, Max = 90 } },
            { "longitude", new ValidationRule { Type = "number", Required = true, Min = -180, Max = 180 } },
        ...
        public DaylightDurationCalculatorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DaylightDurationCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DaylightDurationCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, DaylightDurationCalculatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(DaylightDurationCalculatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(DaylightDurationCalculatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(DaylightDurationCalculatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(DaylightDurationCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(DaylightDurationCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(DaylightDurationCalculatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(DaylightDurationCalculatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(DaylightDurationCalculatorQueryOptions options)
        {
