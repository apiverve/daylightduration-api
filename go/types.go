// Package daylightduration provides a Go client for the Daylight Duration Calculator API.
//
// For more information, visit: https://apiverve.com/marketplace/daylightduration?utm_source=go&utm_medium=readme
package daylightduration
...
// Request contains the parameters for the Daylight Duration Calculator API.
//
// Parameters:
//   - latitude (required): number - Latitude of the location [min: -90, max: 90]
//   - longitude (required): number - Longitude of the location [min: -180, max: 180]
//   - date: string - Date in YYYY-MM-DD format (defaults to today) [format: date]
type Request struct {
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"latitude": {Type: "number", Required: true, Min: float64Ptr(-90), Max: float64Ptr(90)},
		"longitude": {Type: "number", Required: true, Min: float64Ptr(-180), Max: float64Ptr(180)},
...
// ResponseData contains the data returned by the Daylight Duration Calculator API.
type ResponseData struct {
	...
	DaylightDuration DaylightDurationData `json:"daylight_duration"`
	DayOfYear int `json:"day_of_year"`
	IsValid bool `json:"is_valid"`
}

// LocationData represents the location object.
type LocationData struct {
	Latitude float64 `json:"latitude"`
	Longitude float64 `json:"longitude"`
}

// DaylightDurationData represents the daylight_duration object.
type DaylightDurationData struct {
