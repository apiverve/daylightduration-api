...
namespace APIVerve\Daylightduration;
...
/**
 * Client for the Daylight Duration Calculator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/daylightduration?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/daylightduration';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DaylightdurationClient] {$message}\n";
        }
    }
}
